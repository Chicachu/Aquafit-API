...
function roles(): AccessControl {
  ...
  ac.grant(Role.MANAGER)
    ...
    .createAny(AccessControlResource.DISCOUNT)
    .readAny(AccessControlResource.DISCOUNT)
    .updateAny(AccessControlResource.DISCOUNT)
    .deleteAny(AccessControlResource.DISCOUNT)
    .createAny(AccessControlResource.USER)
    .updateAny(AccessControlResource.USER)
