...
router.get('/users/:userId', isLoggedIn, hasAccess(AccessControlAction.READ_ANY, AccessControlResource.ENROLLMENT), enrollmentCotroller.getClientEnrollmentDetails)
